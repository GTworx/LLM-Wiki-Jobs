...
**Category**: Tool / Containerization  
**Demand Score**: High (Extracted from 4 wiki postings)

---

## Overview  
Containerization platform enabling application isolation, deployment consistency, and microservice packaging.
